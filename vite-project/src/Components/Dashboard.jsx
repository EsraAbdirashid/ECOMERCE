...
<div className="imag">
          ...
          {/* mens */}
          <div className="Mens mt-4 bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 h-screen flex justify-center m-auto text-center p-7">
        <div className="text_button translate-x-9 ">
